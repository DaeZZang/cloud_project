...
struct predicacheAdapter
{
    BTree tree;

public:
    void scan(const typename Record::Key& key, const function<bool(const typename Record::Key&, const Record&)>& found_record_cb, std::function<void()> reset_if_scan_failed_cb) {
